...
import 'package:beposoft/pages/ACCOUNTS/emi_report.dart';
    ...
    try {
      var response = await http.post(
        ...
        body: {
          ...
          "emi_amount":calculatedEmi.toString(),
          "total_interest":totalInterestAmount.toString(),
          "total_payment":totalAmountWithInterest.toString(),
        },
      );
      print(response.statusCode);
