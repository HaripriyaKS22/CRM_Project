                                ...
                                Container(
                                  ...
                                  child: Row(
                                    children: [
                                      SizedBox(width: 30),
                                      Text(
                                        '${selectejoin.year}-${selectejoin.month}-${selectejoin.day}',
                                        style: TextStyle(fontSize: 15, color: Color.fromARGB(255, 116, 116, 116)),
                                      ),
                                      SizedBox(width: 162),
                                      GestureDetector(
                  ...
                  ElevatedButton(
                    onPressed: () {
                      setState(() {
                        ...
                        print(stat);
                                        RegisterUserData(name.text,username.text,email.text,phone.text,alternate_number.text,password.text,selectedDepartmentId!,selectedImage,selectedDate,selectedStateId!,selectgender,selectmarital,driving_license.text,employment_status.text,selecteExp,designation.text,grade.text,address.text,city.text,Country.text,selectejoin,selecteconf,selectedImage1,scaffoldContext);
