...
class add_product_variant extends StatefulWidget {
  final id;
  const add_product_variant({super.key,required this.id});
    ...
    try {
     ...
     print("==============0000000000000000000000000${response.body}");
      ...
      if (response.statusCode == 200) {
        ...
        print("perooooooooooooooooooooooooooooooooooo$productsData");

        setState(() {
         
          product.text = productsData[0]['name'] ?? '';
          print("tttttttttttttttttttttttttttttttttttttt${productsData['name']}");
    ...
    children: [
      ElevatedButton(
        ...
        style: ButtonStyle(
          ...
          foregroundColor: MaterialStateProperty.all<Color>(Colors.blue), // Set text color to blue
          shape: MaterialStateProperty.all<RoundedRectangleBorder>(
            RoundedRectangleBorder(
              borderRadius: BorderRadius.circular(10), // Set your desired border radius
              side: BorderSide(color: Colors.blue), // Set the border color to blue
            ),
          ),
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        if (selectedValues.contains(item['value']))
                          Icon(Icons.check, color: Colors.blue), // Indicate selected items
                      ],
                    ),
                  );
                }).toList(),
              ...
              return Chip(
                ...
                onDeleted: () {
                  setState(() {
                    ...
                    print("Updated Selected Values: $selectedValues");
                  });
                },
              );
            }).toList(),
