...
class update_local_assets extends StatefulWidget {
  final id;
  const update_local_assets({super.key, required this.id});

  @override
  State<update_local_assets> createState() => _update_local_assetsState();
}

class _update_local_assetsState extends State<update_local_assets> {
  @override
  void initState() {
    super.initState();
    getlocalassets();
      ...
      if (response.statusCode == 200) {
        ...
        for (var productData in productsData) {
          ...
          if (widget.id == productData['id']) {
            assetsname.text = productData['name'] ?? '';
            ;
          }
        }
        setState(() {
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Container(
                                width: constraints.maxWidth * 0.9,
                                child: TextField(
                                  controller: assetsname,
                                  decoration: InputDecoration(
                                    hintText: assetsname.text.isNotEmpty
                                        ? assetsname.text
                                        : 'Enter Assets Name',
                              ...
                              SizedBox(height: 15),
                               ...
                               Container(
                                ...
                                child: TextField(
                                  controller: quantity,
                                  decoration: InputDecoration(
                                    hintText: quantity.text.isNotEmpty
                                        ? quantity.text
                                        : 'Enter Quantity',
                                    border: OutlineInputBorder(
                                      borderRadius: BorderRadius.circular(10.0),
                              ...
                              SizedBox(height: 15),
                               ...
                               Container(
                                ...
                                child: TextField(
                                  controller: price,
                                  decoration: InputDecoration(
                                    hintText: price.text.isNotEmpty
                                        ? price.text
                                        : 'Enter Price',
                                    border: OutlineInputBorder(
                                      borderRadius: BorderRadius.circular(10.0),
                                  ...
                                  child: GestureDetector(
                                    onTap: () {
                                      Navigator.push(
                                          context,
                                          MaterialPageRoute(
                                              builder: (context) => update_local_assets(
                                                  id: assets[i]['id'])));
                                    },
                                    child: Image.asset(
                                      "lib/assets/edit.jpg",
